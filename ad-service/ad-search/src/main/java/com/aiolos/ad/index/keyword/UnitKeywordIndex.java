package com.aiolos.ad.index.keyword;
...
public class UnitKeywordIndex implements IndexAware<String, Set<Long>> {
    ...
    public void delete(String key, Set<Long> value) {
        ...
        // value中可能只存了部分id，而不是所有key对应的ids，所以先根据key取出set，再remove相应的value
        Set<Long> unitIdSet = CommonUtils.getOrCreate(key, keywordUnitMap, ConcurrentSkipListSet::new);
        ...
        log.info("UnitKeywordIndex, after: {}", unitKeywordMap);
    }
