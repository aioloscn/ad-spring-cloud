...
import com.aiolos.ad.mysql.dto.ParseTemplate;
import com.aiolos.ad.mysql.dto.TableTemplate;
import com.aiolos.ad.mysql.dto.Template;
    ...
    private void loadMeta() {
        ...
        for (Map.Entry<String, TableTemplate> entry : template.getTableTemplateMap().entrySet()) {
            ...
            jdbcTemplate.query(SQL_SCHEMA, new Object[] {
                ...
                if ((updateFields != null && updateFields.contains(colName)) || (insertFields != null && insertFields.contains(colName))
