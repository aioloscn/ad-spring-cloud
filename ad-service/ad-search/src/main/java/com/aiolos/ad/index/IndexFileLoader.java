...
import com.aiolos.ad.handler.AdLevelDataHandler;
...
public class IndexFileLoader {
    ...
    public void init() {
        ...
        adUnitItStrings.forEach(d -> AdLevelDataHandler.handleLevel4(
                JSON.parseObject(d, AdUnitItTable.class), OpType.ADD
        ));
        ...
        adUnitKeywordStrings.forEach(d -> AdLevelDataHandler.handleLevel4(
                JSON.parseObject(d, AdUnitKeywordTable.class), OpType.ADD
        ));
    }
